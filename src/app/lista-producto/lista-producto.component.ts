...
@Component({
  ...
  imports: [MatListModule, CommonModule, MatCardModule, MatIconModule, ProductoDetalleComponent],//MatListModule, CommonModule, MatCardModule, MatIconModule, ProductoDetalleComponent
